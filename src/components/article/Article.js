...
class Article extends Component {
  ...
  loadArticle = async () => {
    try {
      const response = await api.get(`articles/${this.props.idArticle}`);
  ...
  deleteArticle = async (article) => {
    try {
      if (window.confirm(`Tem certeza que deseja excluir o artigo: "${article.title}"?`)) {
        const response = await api.delete(`articles/${this.props.idArticle}`);
  ...
  renderTypes = () => {
    const types = this.state.article.types || [];
    console.log(types)
          ...
          <div className="col-md-12">
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div className="dropdown no-arrow">
                  ...
                  <div id="dropdown-article-new" className="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                    ...
                    <div className="dropdown-header">Ações do artigo:</div>
                    {/* <div className="dropdown-item" href="#">Publicar</div> */}
                    <div className="dropdown-item" onClick={() => this.setState({ show: true })}>
                      Pré-Visualizar
                    </div>
                    <Link className="dropdown-item" to={`/articles/edit/${article.slug}`}>
                      Editar
                    </Link>
              ...
              <div className="card-body">
                ...
                <p><strong>Tipo de Artigo: </strong></p>
                <div className="row">
                  {this.renderTypes()}
                </div>
